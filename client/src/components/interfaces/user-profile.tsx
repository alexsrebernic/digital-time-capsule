            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-muted-foreground mb-4">
                  Time traveler, memory keeper, and digital archivist. Preserving moments for future generations.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <dl className="grid grid-cols-2 gap-4 text-center">
                <div>
                  <dt className="text-sm font-medium text-muted-foreground">Total Created</dt>
                ...
                <div>
                  <dt className="text-sm font-medium text-muted-foreground">Collaborations</dt>
                  <dd className="text-2xl font-semibold">7</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-muted-foreground">Days Until Next</dt>
