...
const capsules = [
	...
	},
	{
		...
		openingDate: "2033-06-01",
		status: "sealed",
	},
	{
		id: 3,
		title: "First Job Memories",
					...
					>
						...
						<CardContent>
							<p className="text-sm text-gray-600">
								Created: {capsule.creationDate}
							</p>
							<p className="text-sm text-gray-600">
								Opens: {capsule.openingDate}
							</p>
						</CardContent>
						<CardFooter>
							<span
