...
import AuthGuardContent from "../auth/AuthGuardContent";
						...
						<div className="flex flex-col items-center space-y-4 text-center">
							<div className="space-y-2">
								...
								<p className="mx-auto max-w-[700px] text-gray-300 md:text-xl">
									Create a time capsule of your digital memories. Share your
									story with future generations.
								</p>
							</div>
							<AuthGuardContent showConnectWallet>
								<div className="space-x-4">
									...
									<Link href="/mycapsules">
										<Button
											variant="outline"
											className="text-purple-600 border-white hover:bg-white hover:text-purple-900"
										>
											My Capsules
										</Button>
									</Link>
