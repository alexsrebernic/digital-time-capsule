    ...
    <div className="min-h-screen bg-teal-50 text-teal-900">
      <header className="bg-teal-600 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl">Preserve your memories for the future, securely and creatively.</p>
        </div>
      </header>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p>Your content is encrypted and stored on a decentralized blockchain, ensuring its integrity and security.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <Lock className="w-12 h-12 text-teal-600 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Time-Locked Content</h3>
              <p>Set a future date for your content to be revealed. It remains securely locked until then.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <Sparkles className="w-12 h-12 text-teal-600 mb-4" />
              <h3 className="text-xl font-semibold mb-2">NFT Integration</h3>
              <p>Your time capsule can be minted as a unique NFT, adding value and authenticity to your digital memories.</p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-teal-600 text-white py-8 mt-12">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; 2023 Digital Time Capsule. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
